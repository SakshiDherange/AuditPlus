...
<body>
  ...
  <h1>Audit Data Dashboard</h1>
    ...
    <script>
      var infrastructure = '<?=$HospitalCount?>';
      var safety = '<?=$ManufacturingCount?>';
      var cleanliness = '<?=$EducationCount?>';
      var staffpoints = '<?=$HospitalityCount?>';
      var maintenance = '<?=$RestaurantCount?>';
      var xValues =["Infrastructure", "Safety","Cleanliness","StaffPoints","Maintenance"];
      var yValues = [infrastructure, safety, cleanliness, staffpoints, maintenance ];
