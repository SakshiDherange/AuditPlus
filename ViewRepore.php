...
<body>
  ...
  <h1> Audit Data Dashboard</h1>
   ...
   <canvas style="display: inline;" id="myChart"></canvas>
    ...
    <script>
      var Institution = '<?=$HospitalCount?>';
      var Teaching = '<?=$ManufacturingCount?>';
      var Library = '<?=$HospitalCount?>';
      var Placement = '<?=$EducationCount?>';
      var IT = '<?=$RestaurantCount?>';
      var Infrastructure = '<?=$EducationCount?>';
      var xValues =["Institution", "Teaching","Library","Placement","IT","Infrastructure"];
      var yValues = [Institution, Teaching, Library, Placement, IT, Infrastructure  ];
