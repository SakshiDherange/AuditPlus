...
$secscore=0;
     $myfile = fopen("responses_hospital.txt", "w")
        ...
        { 
            ...
            $sql1 = "SELECT * FROM questionnaire where question_id = ($i+217);";
