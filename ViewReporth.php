...
<body>
  ...
  <h1>Audit Data Dashboard</h1>
    ...
    <script>
      var Safety = '<?=$HospitalCount?>';
      var Care = '<?=$ManufacturingCount?>';
      var Quality = '<?=$EducationCount?>';
      var  Administrative = '<?=$HospitalityCount?>';
      var infrastructure = '<?=$RestaurantCount?>';
      var xValues =["Safety", "Care","Quality","Administrative","infrastructure"];
      var yValues = [Safety, Care, Quality, Administrative, infrastructure ];
