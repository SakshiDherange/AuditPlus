<?php
    session_start();
    error_reporting(0);
    $_SESSION['subSector1'] = 'Patient Safety';
    $_SESSION['subSector2'] = 'Patient Care Processes';
    $_SESSION['subSector3'] = 'Quality Management';
    $_SESSION['subSector4'] = 'Administrative and Operational';
    $_SESSION['subSector5'] = 'Biomedical Engineering Equipment';
    $_SESSION['subSector6'] = 'Hospital Infrastructure';
...
<div class="container-fluid">
    ...
    <!-- Audit Details -->
<form class="sector-details" action ="Hospital1.php" method="POST" autocomplete = "off">

    <label class="auditdetails" for="auditNo">Audit No:      
        <input class="auditdetails" type="text" id="auditNo" name = "audit"></label>
    <label class="auditdetails" for="hospitalName">Hospital Name:
...
<div id="PatientSafety" class="tabcontent">
        <h3 style="color :blue">Patient Safety</h3>
        <!-- <form> -->
...
<?php
   ...
   {
       $_SESSION['HospitalCount']++;
        include 'HospitalInsert.php';
   }
...
//    }
?>
   <footer id="Contact" style="background-color:rbg(1,1,54); color:white; text-align:center;border:solid white">
